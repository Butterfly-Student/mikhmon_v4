...
export function logApiRequest(config: { method?: string; url?: string; headers?: Record<string, string>; data?: unknown }) {
...
export function logApiResponse(requestId: string, response: { status?: number; statusText?: string; headers?: Record<string, string>; data?: unknown } | undefined, error?: Error) {
  ...
  if (existingRequestIndex >= 0) {
    ...
    const apiResponse: ApiRequest = {
      ...
      responseHeaders: error ? undefined : response?.headers,
